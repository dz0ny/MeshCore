...
int TelemetryScreen::render(DisplayDriver& display) {
  ...
  // Draw header
  DRAW_SCREEN_HEADER("Telemetry", _task);
  ...
  if (has_gps_location) {
    y += line_spacing;
    display.setColor(DisplayDriver::GREEN);
    display.drawTextLeftAlign(0, y, "Latitude");
    display.setColor(DisplayDriver::LIGHT);
    ...
    y += line_spacing;
    display.setColor(DisplayDriver::GREEN);
    display.drawTextLeftAlign(0, y, "Longitude");
    display.setColor(DisplayDriver::LIGHT);
